...
eigen_path = "./dvs_warping_package/eigen-3.4.0"
...
setuptools.setup(
    ...
    packages=["dvs_warping_package"],
    ext_modules=[
        setuptools.extension.Extension(
            "dvs_warping_package_extension",
            language="c++",
            sources=["dvs_warping_package_extension/dvs_warping_package_extension.cpp"],
